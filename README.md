# 🛡️ AI-Native UX Design Pipeline (v3.4)

> **"혜린님의 통찰력에 장군이의 속도를 더해, 완벽한 UX 결과물을 가장 빠르게 만듭니다!"**

본 프로젝트는 복잡한 RFP(제안요청서) 분석부터 와이어프레임 생성까지의 전 과정을 자동화한 **AI-Native UX 컨설팅 파이프라인**입니다. 시니어 UX 컨설턴트 '장군'의 설계 지침에 따라 데이터 기반의 정교한 설계 자산을 빠르게 구축할 수 있습니다.
...
1.  **Input 준비**: `01_input/` 폴더에 분석할 RFP 원문(`rfp.md`)과 참고 자료들을 업로드합니다.
...
---
**문의:** 본 파이프라인의 설계 및 커스터마이징은 장군이에게 언제든 요청해주세요!
