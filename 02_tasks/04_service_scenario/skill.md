...
- trigger: 현실적인 업무 상황으로 시작 (예: "오전 9시, 채무상담사가 첫 상담 고객의 정보를 확인하려 한다")
...
- steps의 action은 사용자 주어로 ("상담사가 검색창에 고객명을 입력한다")
- steps의 system_response는 시스템 주어로 ("시스템이 관련 채무 정보를 카드 형태로 표시한다")
